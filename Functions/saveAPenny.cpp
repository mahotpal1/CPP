...
double a_penny_doubled_everyday(int n,double total_amount=0.01);//----WRITE THE FUNCTION PARAMETER LIST WITHIN THE PARENTHESES
...
double a_penny_doubled_everyday(int n, double total_amount) {//----WRITE THE FUNCTION PARAMETER LIST WITHIN THE PARENTHESES
    ...
    return a_penny_doubled_everyday(n-1, 2*total_amount);
