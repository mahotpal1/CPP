...
string print_guest_list(const std::string guest_list[], size_t value);//----WRITE THE FUNCTION PARAMETER LIST WITHIN THE PARENTHESES
void clear_guest_list(std::string guest_list[], size_t value);//----WRITE THE FUNCTION PARAMETER LIST WITHIN THE PARENTHESES
                                      
//----WRITE THE FUNCTION PROTOTYPES ABOVE THIS LINE----                                      
//----DO NOT MODIFY THE CODE BELOW THIS LINE----

int event_guest_list() {
...
void clear_guest_list(std::string guest_list[],size_t value) {//----WRITE THE FUNCTION PARAMETER LIST WITHIN THEPARENTHESES
